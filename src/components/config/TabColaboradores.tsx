                ...
                {showTeamForm && (
                    <div className="bg-purple-50 border border-purple-200 rounded-lg p-4 flex gap-4 items-end">
                        <div className="flex-1">
                            ...
                            <input value={teamForm.nombre} onChange={e => setTeamForm({ nombre: e.target.value })} className="w-full px-3 py-2 border rounded-lg mt-1" placeholder="Ej: Equipo Isidora" />
                        </div>
                ...
                {showUserForm && (
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 space-y-3">
                        ...
                        <div className="grid grid-cols-4 gap-3">
                            <input placeholder="Nombre *" value={userForm.nombre} onChange={e => setUserForm({ ...userForm, nombre: e.target.value })} className="px-3 py-2 border rounded-lg" />
                            <input placeholder="Email *" value={userForm.email} onChange={e => setUserForm({ ...userForm, email: e.target.value })} disabled={!!editingUser} className="px-3 py-2 border rounded-lg disabled:bg-slate-100" />
